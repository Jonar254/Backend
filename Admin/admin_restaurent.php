...
<head>
  ...
  <title>DigitalMini Resturant - Admin-Home</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">DigitalMini Resturant Admin</div>
      </a>
             ...
             <thead>
              <tr><h5>Restaurent List's</h5></tr>
               ...
               <tbody>
                ...
                <?php
                $sql = "select * from restaurents order by rid desc;";
                ...
                ?>
                 ...
                 <tr>
                   ...
                   <td><?php echo $row['rplace']; ?></td>
                   <td><?php echo $row['rcontactno']; ?></td>
                   <td><?php echo $row['raddress']; ?></td>
                   <td><a class="btn btn-success btn-sm m-1" href="includes/status.inc.php?rid=<?php echo $row['rid']; ?>">Enable</a><br> 
                   <a href="includes/statuss.inc.php?rid=<?php echo $row['rid']; ?>" class="btn btn-danger btn-sm">Disable</a></td>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; DigitalMini Resturant</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
